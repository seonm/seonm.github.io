(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [606, 158],
  {
    ...
    7290: function (t, e, n) {
      ...
      var A = function (t) {
        return d.createElement(
          ...
          i || (i = d.createElement('path', { fill: '#FAE100', d: 'M0 0h24v24H0z' })),
          c ||
            (c = d.createElement('path', {
              fill: '#007DFF',
        ...
        return d.createElement(
          ...
          d.createElement(
            ...
            d.createElement(
              ...
              s || (s = d.createElement('path', { fill: '#fff', d: 'M0 0h24v24H0z' }))
            ),
            o ||
              (o = d.createElement(
                'g',
      ...
      var C = function (t) {
        return d.createElement(
          'svg',
          N({ xmlns: 'http://www.w3.org/2000/svg', width: 24, height: 24, fill: '#fff', viewBox: '0 -960 960 960' }, t),
          g ||
    ...
    2573: function (t, e, n) {
      ...
      function u(t) {
        let { children: e, size: n = 'md', color: a = 'text-black', font: i, align: u = 'left', className: f } = t;
        return (0, r.jsx)('div', {
          className: ''
            .concat(s[n], ' ')
            .concat(a, ' ')
    ...
    7074: function (t, e, n) {
      ...
      var r = n(5893),
        ...
        i = n(7294);
      function c(t) {
        let { name: e, account: n, bank: c } = t,
          [s, o] = (0, i.useState)(!1),
          u = async () => {
            try {
              await navigator.clipboard.writeText(''.concat(c, ' ').concat(n)), alert('복사되었습니다.');
            } catch (t) {
              console.error('복사 실패: ', t);
            }
          };
        return (0, r.jsxs)('div', {
          onClick: u,
          ...
          children: [
            (0, r.jsxs)('div', {
              ...
              children: [
                (0, r.jsxs)('div', {
                  children: [
                    (0, r.jsx)(l.Z, { size: 'xs', children: c }),
                    (0, r.jsx)(l.Z, { size: 'md', className: 'break-all', children: n }),
                  ],
                }),
                (0, r.jsx)(l.Z, { className: 'min-w-10 break-keep', size: 'md', children: e }),
              ],
            }),
            (0, r.jsx)(a.CK, {}),
          ],
